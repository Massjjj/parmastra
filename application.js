...
function setupSex() {
  const total = document.getElementById('sex-total');
  const males = document.getElementById('sex-males');
  const females = document.getElementById('sex-females');
  
  // all'inizio sono selezionati entrambi i sessi
  total.style.color = 'yellow';
  total.style.borderColor = 'yellow';
  males.style.color = 'white';
  males.style.borderColor = 'white';
  females.style.color = 'white';
  females.style.borderColor = 'white';
  ...
  males.addEventListener('click',() => {
    ...
    total.style.borderColor = 'white';
    males.style.color = 'yellow';
    males.style.borderColor = 'yellow';
    females.style.color = 'white';
    females.style.borderColor = 'white';
    applyFilters(); 
  });
  ...
  females.addEventListener('click',() => {
    ...
    males.style.color = 'white';
    males.style.borderColor = 'white';
    females.style.color = 'yellow';
    females.style.borderColor = 'yellow'; 
    applyFilters(); 
  });
}
...
function updateQuartieriButtonsColor() {
  ...
  if (state.filters.quartieri.size == 13) {
    selectall.style.color = 'yellow'; 
    selectall.style.borderColor = 'yellow'; 
    deselectall.style.color = 'white'; 
    deselectall.style.borderColor = 'white'; 
  }
  else if (state.filters.quartieri.size == 0) {
    selectall.style.color = 'white'; 
    selectall.style.borderColor = 'white'; 
    deselectall.style.color = 'yellow'; 
    deselectall.style.borderColor = 'yellow'; 
  }
  else {
    selectall.style.color = 'white'; 
    selectall.style.borderColor = 'white'; 
...
async function setupWorld() {
  ...
  const worldData = await loadMapData();
  let geolayer; 
  geolayer = L.geoJson(worldData,{
...
function setupCountriesAll() {
  const button = document.getElementById('all-countries'); 
      ...
      geolayer.eachLayer((layer) => {
        ...
        if (e.ctrlKey || e.metaKey) {
          ...
          if (countries.has(country)) {
            ...
            state.filters.countries.delete(country);
            layer.setStyle(basicCountryStyle(country)); 
          }
        }
      });  
      applyFilters();   
